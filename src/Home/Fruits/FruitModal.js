...
const FruitModal = ({ items }) => {
    ...
    return (
        <div>
            ...
            < input type="checkbox" id="fruit-modal" className="modal-toggle" />
            <div className="modal">
                <div className="modal-box relative">
                    <label htmlFor="fruit-modal" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
                        ...
                        <div className="hero-content flex-col lg:flex-row">
                            ...
                            <div>
                                ...
                                <div className='flex justify-start align-center'>
                                    <p className='pb-2 font-bold'>price: ${newPrice}</p>
                                    <p className='underline underline-offset-4 pb-2 text-gray-400 ml-3'>price_old: ${price_old}</p>
                                </div>
